...
- User sync credential selection is now OAuth-first with GitHub App installation fallback, and expired OAuth access tokens are refreshed in `github-ingestor` from persisted refresh tokens before authored-PR discovery proceeds.
