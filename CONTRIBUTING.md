...
- Frontend JSX policy scripts share `frontend/scripts/lib/jsx-source-scan.mjs`; add new AST-based UI guards, including accessible-name, decorative-icon, new-tab-link, and polymorphic-button checks, through that helper instead of copying parser/walker code.
