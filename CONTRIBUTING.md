...
- Scheduler execution is still bounded and in-process; there is no separate production worker fleet for all long-running sync, analysis, scoring, profile, leaderboard, and notification work.
