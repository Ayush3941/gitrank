...
func TestSyncRequestNormalizeValidatesQuestBackfillUserID(t *testing.T) {
	req := SyncRequest{
	...
	req = SyncRequest{Mode: "quest_backfill_user", UserID: "octocat"}
	if err := req.Normalize(); err == nil {
		t.Fatal("Normalize() error = nil, want invalid user_id rejection")
	}
}

func TestSyncRequestNormalizeValidatesScoreHistoryBackfillUserID(t *testing.T) {
	req := SyncRequest{
	...
	req = SyncRequest{Mode: "score_history_backfill_user", UserID: "octocat"}
	if err := req.Normalize(); err == nil {
		t.Fatal("Normalize() error = nil, want invalid user_id rejection")
	}
}

func TestSyncRequestNormalizeValidatesBadgeBackfillUserID(t *testing.T) {
	req := SyncRequest{
	...
	req = SyncRequest{Mode: "badge_backfill_user", UserID: "octocat"}
	if err := req.Normalize(); err == nil {
		t.Fatal("Normalize() error = nil, want invalid user_id rejection")
	}
}
