...
[ -n "$APP_ID" ] || fail "GITHUB_APP_ID is required"
[ -n "$INSTALLATION_ID" ] || fail "GITHUB_APP_INSTALLATION_ID is required"
...
if [ -z "$PRIVATE_KEY_FILE" ]; then
  [ -n "$PRIVATE_KEY_PEM" ] || fail "set GITHUB_APP_PRIVATE_KEY_FILE or GITHUB_APP_PRIVATE_KEY_PEM"
