...

{
  ...
  printf '```\n\n'
  printf '4. Run public controls precheck and fix branch protection first if needed.\n'
  printf '\n'
  printf '```bash\n'
  printf 'cd gitrank\n'
  printf 'GITHUB_REPOSITORY=%s make verify-github-repository-controls-public\n' "${gitrank_repo:-OWNER/REPO}"
  printf '```\n\n'
  printf '5. Run live-gates workflow evidence pipeline.\n\n'
  printf '```bash\n'
  printf 'cd gitrank\n'
  ...
  printf '```\n\n'
  printf '6. Generate rollback and restore drill evidence (or provide equivalent real drill records).\n\n'
  printf '```bash\n'
  printf 'cd gitrank\n'
  ...
  printf '```\n\n'
  printf '7. Finalize checklist marking and re-audit.\n\n'
  printf '```bash\n'
  printf 'cd gitrank\n'
