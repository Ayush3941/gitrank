...
for key in DATABASE_URL REDIS_URL GITRANK_SESSION_SECRET GITRANK_PREVIOUS_SESSION_SECRETS GITRANK_JWT_SIGNING_KEY GITHUB_TOKEN_ENCRYPTION_KEY GITHUB_PREVIOUS_TOKEN_ENCRYPTION_KEYS GITHUB_CLIENT_ID GITHUB_CLIENT_SECRET GITHUB_WEBHOOK_SECRET GEMINI_API_KEY GRAFANA_ADMIN_USER GRAFANA_ADMIN_PASSWORD; do
