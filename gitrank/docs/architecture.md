...
- the scheduler owns `score.replay_user`, `profile.refresh_user`, `report.materialize_pull_request`, `leaderboard.materialize_season`, and `pipeline.grade_pull_request` job orchestration
