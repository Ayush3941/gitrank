...
- a substantial Next.js frontend with dashboard, profile, leaderboard, quest, badge, onboarding, and PR-report flows, with live profile/settings/account actions, live dashboard/badge/contribution data from the authenticated profile snapshot, live leaderboard data from public profile snapshots, and mock-backed quest and PR-report surfaces
