  ...
  return (
    <aside className="glass-panel cyber-card cyber-frame neon-outline hidden h-fit w-full shrink-0 p-4 xl:flex xl:flex-col xl:justify-between">
      <div className="space-y-5">
        ...
        <div className="dashboard-nav-shell space-y-3.5 p-3.5">
                ...
                return (
                  <li key={item.href}>
                    <Link
                      ...
                      className={cn(
                        "focus-ring dashboard-nav-item group relative flex min-h-[3.75rem] items-start gap-3 px-3 py-2.5 text-sm leading-5",
                      )}
                    >
                      <span
                        className={cn(
