  ...
  return (
    <AppShell>
      <div className="space-y-8">
        <header className="glass-panel cyber-card cyber-frame panel-grid neon-outline flex items-center justify-between rounded-[2rem] px-5 py-4">
        ...
        {children}
        <footer className="cyber-terminal panel-grid rounded-[1.75rem] px-5 py-6 text-sm text-muted">
