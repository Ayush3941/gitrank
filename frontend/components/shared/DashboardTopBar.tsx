...
export function DashboardTopBar({ user }: { user: UserProfile }) {
  return (
    <div className="glass-panel cyber-card panel-grid sticky top-4 z-30 mb-6 flex flex-col gap-4 rounded-[2rem] px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
...
export function DashboardTopBarUnavailable() {
  return (
    <div className="glass-panel cyber-card panel-grid sticky top-4 z-30 mb-6 flex flex-col gap-4 rounded-[2rem] border border-amber-400/24 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
