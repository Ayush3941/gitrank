  ...
  return (
    ...
    >
      <ul
        role="list"
        className={cn(
          "dashboard-nav-track lane-rail flex flex-wrap gap-2 overflow-visible p-0.5 sm:grid sm:grid-cols-5 sm:p-0",
        )}
      >
        {dashboardNavItems.map((item) => {
          ...
          return (
            <li key={item.href} className="list-none min-w-[6.25rem] shrink-0 sm:min-w-0">
              <Link
                href={item.href}
