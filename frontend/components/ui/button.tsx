...
const buttonVariants = cva(
  "focus-ring inline-flex items-center justify-center gap-2 rounded-[var(--radius-universal)] border border-transparent font-medium disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        icon: "h-10 w-10 rounded-[var(--radius-universal)]",
      },
    },
    defaultVariants: {
      variant: "default",
