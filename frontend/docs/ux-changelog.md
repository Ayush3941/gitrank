...
- Frontend orphan cleanup:
  ...
  - extracted shared JSX policy scanning into `frontend/scripts/lib/jsx-source-scan.mjs` so accessibility, accessible-name, decorative-icon, main-landmark, navigation-landmark, nested-interactive, new-tab-link, polymorphic-button, and interaction guards stop duplicating parser/walker code.
