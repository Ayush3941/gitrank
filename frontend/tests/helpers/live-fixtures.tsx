...
export const abraInsightsFixture = {
...
export const privateProfileFixtureStale = {
  ...privateProfileFixture,
  staleness: {
    ...privateProfileFixture.staleness,
    is_stale: true,
  },
};
...
export const questFixtureStale = {
  ...questFixture,
  staleness: {
    ...questFixture.staleness,
    is_stale: true,
  },
};

export const accountExportFixture = {
